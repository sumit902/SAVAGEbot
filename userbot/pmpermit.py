...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/a7569a3504a269c9ee9f4.mp4"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By LegendBOT 🇮🇳"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is LegendBOT PM Protection Service ⚠️**\n\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1343556834, 1100231654, 554048138)))
