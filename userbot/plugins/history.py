...
async def _(event):
    ...
    await event.edit("```ruk abhi nikal ta hu history is bhosdiwale ki ```")
    ...
    async with borg.conversation(chat) as conv:
          ...
          if response.text.startswith("Forward"):
             ...
             await event.edit("```settings m jaa privacy settings open kr waha forwad msg privacy ko anybody p rakh aur jaldi aa ```")
