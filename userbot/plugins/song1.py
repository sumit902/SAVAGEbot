...
#porting to hellbot by @kraken_the_badass... and now ported to ᔕᗴᑎᔕᗴᎥᗰᗩ᙭-Kingbot
#secon userbot to port javes song module...
...
async def download_video(v_url):  
    ...
    if type == "audio":
        ...
        song = True    
    try:
        await rkp.edit("`Please wait while ᔕᗴᑎᔕᗴᎥᗰᗩ᙭-Kingbot loads your awesome song..`")
