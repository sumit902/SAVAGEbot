#editing and copying the plugin is not allowed
#creadit to sawan (@veryhelpful)
...
@borg.on(admin_cmd(pattern=r"sdirty$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    await event.edit("wait @veryhelpful making a dirty sahyri for u .....")
